...
@dp.message(F.text == "Митап \"ИИ в действии: подключаем, тестируем, оптимизируем\"")
async def meetup_info(message: types.Message):
    response_text = (
        "📢 **Митап: \"ИИ в действии: подключаем, тестируем, оптимизируем\"**\n\n"
        "На митапе обсудим практическое применение ИИ, протестируем новые технологии и найдем пути для оптимизации процессов. 🚀\n\n"
